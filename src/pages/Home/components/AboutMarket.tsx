...
export function AboutMarket() {
  return (
    <div className="bg-neutral-900 p-6 rounded-lg shadow-md max-w-6xl mx-auto">
      ...
      <div className="bg-neutral-800 text-gray-300 p-4 h-[200px] flex flex-row justify-around items-end rounded-lg shadow mb-8">
        {/* <MarketChart />*/}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-neutral-700 p-4 rounded-lg shadow hover:shadow-lg transition">
          <h3 className="text-xl font-semibold text-blue-600 mb-2">🏢 Empresas e Comércio</h3>
        ...
        <div className="bg-neutral-700 p-4 rounded-lg shadow hover:shadow-lg transition">
          <h3 className="text-xl font-semibold text-green-600 mb-2">🎧 Atendimento ao Cliente</h3>
          <p className="text-gray-200">
        ...
        <div className="bg-neutral-700 p-4 rounded-lg shadow hover:shadow-lg transition">
          <h3 className="text-xl font-semibold text-purple-600 mb-2">🛒 Vendas e Comércio</h3>
          <p className="text-gray-200">
